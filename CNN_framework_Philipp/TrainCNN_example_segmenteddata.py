...
import DeepPhase.gen_seg as gen
import DeepPhase.class_analyse as analyse

""" Check using GPU backend!!!"""
#==============================================================================
...
# Define parameters for Data Generation 
params = {'x_dim': 18000,
          'y_dim': 3, # y_dim is number of feature vectors 
          'batch_size': 50,
          'shuffle': True,
          "train_data_path":'../../myData/batch_format_maule/train/data/',
          "label_data_path":'../../myData/batch_format_maule/train/labels/',
          'no_windows':500,
          'windowlen':2800,
          'centred_ratio':0.5,
          'numclasses':3,
...
IDs = ['b{}'.format(i) for i in range(1,65)]
val_IDs = ['b{}'.format(i) for i in range(66,77)]
test_IDs = ['b{}'.format(i) for i in range(78,90)]
...
""" Save trained model """
#==============================================================================
model_name = 'CNN_2800_5050_500winpbatch3comp_contstd_xtrapicks_gaussnorm_40_2test'
# Save model locally
