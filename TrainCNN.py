...
params = {"shuffle":False,
          "train_data_path":'./Data/final_data2train/data/',
          "label_data_path":'./Data/final_data2train/labels/',
          "windowlen":2800,
          "timestep":1400,
          "batch_size":50} 

# Specify IDs for batches
IDs = ['b{}'.format(i) for i in range(1,40)]
val_IDs = ['b{}'.format(i) for i in range(41,45)]
test_IDs = ['b{}'.format(i) for i in range(46,51)]
...
""" Save trained model """
#==============================================================================
model_name = 'CNN_2800_5050_500winpbatch3comp_contstd_xtrapicks2'
# Save model locally
pathlib.Path('./Analyse/models/').mkdir(exist_ok=True, parents=True)
model.save('./Analyse/models/'+model_name)
